export interface AuthField {
  ...
  placeholder?: string; isRequired?: boolean;
}
export interface AddonIcon { type: string; value: string; }
export interface CatalogEntry { id: string; name: string; isDefault?: boolean; }
export interface ResourceDefinition {
  type: string; idPrefixes?: string[]; catalogs?: CatalogEntry[];
}
export interface AuthDefinition {
  type: string; label?: string; fields?: AuthField[];
}
